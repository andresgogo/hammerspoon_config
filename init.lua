...
hotkey.bind(mash, "o", function()
	openURL("https://chatgpt.com/", false)
end)
hotkey.bind(mash, "p", function()
	openURL("https://claude.ai", true)
end)
...
hotkey.bind(mash, "r", function()
	application.launchOrFocus("Raycast")
end)
hotkey.bind(mash, "6", function()
	application.launchOrFocus("Google Chrome")
end)
hotkey.bind(mash, "5", function()
